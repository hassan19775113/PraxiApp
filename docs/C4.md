...
System_Boundary(api, "Django REST API") {
  ...
  Component(patients, "patients App", "Cache", "patients_cache (System-DB)")
  Component(medical, "medical App", "Read-only Views", "Legacy Patient Zugriff")
...
Rel(medical, core, "RBAC + Audit Logging")
