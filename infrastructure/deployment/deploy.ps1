...
# Repo root (this script lives in infrastructure/deployment)
...
if (Test-Path (Join-Path $RepoRoot ".venv312\Scripts\Activate.ps1")) {
    & (Join-Path $RepoRoot ".venv312\Scripts\Activate.ps1")
