...
class OpStatsMiniTest(TestCase):
    ...
    def test_stats_and_rbac(self):
        ...
        r_overview_doc = doctor_client.get(
            "/api/op-stats/overview/", {"date": self.day.isoformat()}
        )
        ...
        r_surgeons_doc = doctor_client.get(
            "/api/op-stats/surgeons/", {"date": self.day.isoformat()}
        )
