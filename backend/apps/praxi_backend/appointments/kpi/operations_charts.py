...
def get_resource_utilization_chart(days: int = 30) -> dict[str, Any]:
    ...
    from praxi_backend.appointments.kpi.operations_kpis import calculate_resource_utilization
    from praxi_backend.appointments.kpi.operations_kpis import get_date_range as kpi_date_range
