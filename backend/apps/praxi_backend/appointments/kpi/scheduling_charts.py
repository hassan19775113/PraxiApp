...
def get_doctor_utilization_chart() -> dict[str, Any]:
	...
	return {
		"labels": labels,
		"datasets": [{"label": "Auslastung %", "data": data, "backgroundColor": colors, "borderRadius": 8}],
	}
...
def get_hourly_load_chart() -> dict[str, Any]:
	...
	return {
		"labels": labels,
		"datasets": [{"label": "Termine", "data": data, "backgroundColor": colors, "borderRadius": 4}],
	}
...
def get_weekday_load_chart() -> dict[str, Any]:
	...
	return {
		"labels": day_names,
		"datasets": [{"label": "Termine", "data": data, "backgroundColor": colors, "borderRadius": 8}],
	}
