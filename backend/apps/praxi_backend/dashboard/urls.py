...
from .doctor_views import DoctorAPIView, DoctorDashboardView
from .operations_views import OperationsAPIView, OperationsDashboardView
...
from .scheduling_views import SchedulingAPIView, SchedulingDashboardView
from .views import DashboardAPIView, DashboardView
...
urlpatterns = [
    ...
    path(
        "appointments/", AppointmentCalendarFullCalendarView.as_view(), name="appointments_calendar"
    ),
    path(
        "appointments/fullcalendar/",
        AppointmentCalendarFullCalendarView.as_view(),
        name="appointments_calendar_fullcalendar",
    ),
    # Legacy-Kalenderansichten (falls noch benötigt)
    path(
        "appointments/legacy/day/",
        AppointmentCalendarDayView.as_view(),
        name="appointments_calendar_day_legacy",
    ),
    path(
        "appointments/legacy/week/",
        AppointmentCalendarWeekView.as_view(),
        name="appointments_calendar_week_legacy",
    ),
    path(
        "appointments/legacy/month/",
        AppointmentCalendarMonthView.as_view(),
        name="appointments_calendar_month_legacy",
    ),
    # Patienten Dashboard
    ...
    path(
        "patients/<int:patient_id>/", PatientDashboardView.as_view(), name="patient_detail"
    ),  # Detail-Ansicht
    path(
